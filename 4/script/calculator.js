...
function getProduct(id) {
    ...
    var price = +(parent === null || parent === void 0 ? void 0 : parent.querySelector("input[name='price']")).value;
...
function calculate() {
    ...
    if (products.includes(undefined)) {
        alert("Hibás vagy hiányzó adatok! Ellenőrizd, hogy az árértékek numerikusak.");
        return;
    }
